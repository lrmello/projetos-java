...
//		Optional<Conta> contaOptional =  banco.buscar(123,898);

//		banco.buscar(123,898).ifPresent(conta -> System.out.println(conta.getSaldo()));
...
//		Conta contaEncontrada = banco.buscar(123,898).orElseThrow(() -> new RuntimeException("Conta não encontrada"));
//
//		System.out.println(contaEncontrada.getSaldo());
